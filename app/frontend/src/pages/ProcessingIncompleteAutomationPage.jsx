      ...
      <QueueTableCard
        ...
        headerAside={
          <CatalogSearchRow
            ...
            buttonsDisabled={creationActionsDisabled}
          />
        }
        actions={
          <div className="processing-card-actions processing-card-actions-grouped">
              ...
              <tr>
                <th className="processing-col-select">
                  <input
                    ...
                    disabled={
                      !selectedIdsOnPage.length || creationActionsDisabled
                    }
                    aria-label={
                      allSelected
      ...
      <section className="detail-card processing-card processing-removed-card">
        <div className="processing-removed-head">
          ...
          <span className="processing-card-count">
            {removedFilters.range === "year"
              ? "Past Year"
              : removedFilters.range === "month"
                ? "Past Month"
                : removedFilters.range === "day"
                  ? "Past Day"
                  : "Past Week"}
          </span>
        </div>
